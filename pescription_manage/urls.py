...
from .views import PatientProfileViewSet, DoctorProfileViewSet, PrescriptionViewSet, PrescriptionCountSingle, UniqueDoctorsForPatient, UniqueDoctorDetailsForPatient
